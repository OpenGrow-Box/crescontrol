...
class CresControl:
        ...
        try:
            ...
            for device in self.devices:
                if device.device_type == DeviceType.SENSOR:
                    ...
                    updated_state = sanitized_sensor_data.get(sensor_id, {})
    ...
    async def update_fan(self):
        ...
        try:
            ...
            _LOGGER.error(f"Error updating fan data: {e}")
    ...
    async def update_inputs(self):
        ...
        try:
            ...
            _LOGGER.error(f"Error updating input data: {e}")
    ...
    async def update_outputs(self):
        ...
        try:
            ...
            _LOGGER.error(f"Error updating output data: {e}")
    ...
    async def update_switches(self):
        ...
        try:
            ...
            _LOGGER.error(f"Error updating switch data: {e}")
    ...
    async def async_close(self):
        """Close the shared aiohttp session if owned."""
